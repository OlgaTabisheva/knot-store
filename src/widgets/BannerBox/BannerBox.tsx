...
export const BannerBox: React.FC<{image:string, name: string, date: string | null,
     text: string | null, about:string, buttonOne: boolean, buttonTwo:boolean,buttonOTwoName: string | null, buttonOneName: string | null  }> 
= ({image, name, date, text, about, buttonOne,buttonTwo, buttonOneName,  buttonOTwoName}) => {
    return (
