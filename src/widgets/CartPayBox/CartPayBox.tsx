...
export const CartPayBox: React.FC <{handleOnClickPopup :any}>= ({handleOnClickPopup}) => {
  ...
  return (
    <div className={style.cartPayBox}>
      ...
      <button className={style.cartPayBox__button} onClick={()=>handleOnClickPopup()}>Оформить заказ</button>
