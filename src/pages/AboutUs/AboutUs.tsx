  ...
  return (
    <div className={style.aboutUs}>
      ...
      <h4 className={style.aboutUs__smallTitle}>
         Наш интернет-магазин выберают, потому что:
        </h4>
      ...
      <div className={style.aboutUs__box}>
        ...
        <p className={style.aboutUs__text}>
          ...
          бюджет. Мы предлагаем широкий ассортимент товаров от известных
          производителей, быструю доставку и удобные способы оплаты.
        </p>
      </div>
