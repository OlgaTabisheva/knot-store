...
<div className={style.userPage__top}>
    ...
    <ButtonClassic name='Корзина' type="button" disabled={false} onClick={() => setButtonUserClick(0)}/>

      <ButtonClassic name='Страница администратора' type="button" disabled={false} onClick={() => setButtonUserClick(1)}/>
    </div>
